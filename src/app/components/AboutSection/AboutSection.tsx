    ...
    },
    {
        ...
        content: (
            <div className="bg-neutral-900 text-white p-6 rounded-lg shadow-md">
                <ul className="list-disc ml-4">
                    <li className="mb-2">
                        <span className="text-lg font-bold">Programming and Software Analysis – CEITI, Chisinau, Moldova:</span>
                        <ul className="list-disc ml-4">
                            <li>4-year course in programming and software analysis</li>
                            <li>Center of Excellence in Informatics and Informational Technologies</li>
                        </ul>
                    </li>
                    <li className="mb-2">
                        ...
                        <ul className="list-disc ml-4">
                            ...
                            <li>Focused on developing a big feature-rich social media application</li>
                        </ul>
                    </li>
        ...
        content: (
            <div className="bg-neutral-900 text-white p-6 rounded-lg shadow-md">
                ...
                <div className="mb-4">
                    ...
                    <ul className="list-disc ml-4">
                        <li>Effective verbal and written communication in English, Russian and Romanian</li>
                        <li>Team Player</li>
                    </ul>
                </div>
                <div>
            ...
            <div className="bg-neutral-900 text-white p-6 rounded-lg shadow-md">
                ...
                <ul className="list-disc ml-4">
                    <li className="mb-2">
                        ...
                        <ul className="list-disc ml-4">
                            <li>Over 8 months learning and practicing front-end with React & Redux</li>
                        </ul>
                    </li>
                    <li className="mb-2">
                        <span className="text-lg font-bold">Commercial Project:</span>
                        <ul className="list-disc ml-4">
                            <li>Over 2 months single-handedly developing a commercial project</li>
                        </ul>
                    </li>
                    <li className="mb-2">
                    ...
                    <li className="mb-2">
                        ...
                        <ul className="list-disc ml-4">
                            <li>Over 6 months developing non-commercial projects to master modern React tech stack</li>
                        </ul>
                    </li>
                </ul>
            </div>
            ...
            <div className="px-2 sm:px-8 md:px-10 lg:px-16 xl:px-[8vw] text-md md:text-lg">
                ...
                <div>
                    ...
                    {TAB_DATA.map((tabItem) => (
                        <div key={tabItem.title} className={activeTab.toLowerCase() === tabItem.title.toLowerCase() ? 'block' : 'hidden'}>
                            {tabItem.content}
                        </div>
                    ))}
                </div>
